...
function UserProfile() {
    ...
    const formattedBirthday = formatDate(store.profile.brithday);
                        ...
                        <div className="section-1">
                            <div className={`profile-card ${store.theme}-cardd`}>
                                <div className="header">
                                    <img src={`${store.url+store.profile.profil_url}`} height={400} style={{ filter:'blur(2px) brightness(0.7)' }} alt="" />
                                </div>
                                <div className="info">
                                    <img src={`${store.url+store.profile.profil_url}`} className='avatar'  alt="" />
                                    ...
                                    <div className="middle">
                                        <p className="fullname">{`${store.profile.lastname} ${store.profile.firstname}`}</p>
