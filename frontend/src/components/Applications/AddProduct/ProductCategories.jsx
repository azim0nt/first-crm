        ...
        <div className={`product-categories`}>
            <div className="left-part">
                <div className="add-category">
                    <h4>{t('add_product.product_form.product_categories.add_category.0')}</h4>
                    ...
                    <h4>{t('add_product.product_form.product_categories.add_category.1')}</h4>
                </div>
                <div className="create-new-category">
                    <button className="blue-btn">
                        <GoPlus color='#5c61f2' size={20} /> {t('add_product.product_form.product_categories.create_new_category')}
                    </button>
                </div>
                <div className="publish-status">
                    <h4>{t('add_product.product_form.product_categories.publish_status.0')}</h4>
                    <select className={store.theme+'-input'} name="" id="" style={inputStyle}>
                        <option value="publish">Publish</option>
                        <option value="drafts">Drafts</option>
                        <option value="unpublish">Unpublish</option>
                    </select>
                    <h4>{t('add_product.product_form.product_categories.publish_status.1')}</h4>
                </div>
            </div>
            <div className="right-part">
                <div className="add-tag">
                    <h4>{t('add_product.product_form.product_categories.add_tag.0')}</h4>
                    ...
                    />
                    <h4>{t('add_product.product_form.product_categories.add_tag.1')}</h4>
                </div>
                <div className="publish-date-time">
                    <h4>{t('add_product.product_form.product_categories.publish_date_time')}</h4>
